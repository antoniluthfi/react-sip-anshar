...
import DataResellerHelper from './modules/DataResellerHelper';
import {
    CCard,
    CCardBody,
    CCardHeader,
    ...
    return (
        <>
            <CRow>
                <CCol xs="12" lg="12">
                    <CCard>
                        <CCardHeader>Data Pelanggan (Reseller)</CCardHeader>
                        <CRow>
                            <CCol xs="6" lg="6">
                                <CButton color="success" onClick={() => setSuccess(!success)} className="ml-3 mt-2">Tambah Data</CButton>
                            
                                <a href={`${process.env.REACT_APP_LARAVEL_PUBLIC}/laporan/pelanggan/data-pelanggan/role/reseller`} target="_blank" rel="noreferrer">
