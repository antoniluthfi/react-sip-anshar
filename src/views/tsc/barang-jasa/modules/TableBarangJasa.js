  ...
  return (
    <CDataTable
      ...
      scopedSlots={{
        ...
        jenis: (item) => <td className="text-center">{item.jenis}</td>,
            ...
            <CCollapse show={details.includes(index)}>
              <CCardBody>
                <CButton
                  size="sm"
                  color="info"
                  onClick={() => getDataBarangJasaById(item.id, "view")}
                >
                  View Details
                </CButton>
                <CButton
                  ...
                  color="success"
                  className="ml-1"
                  onClick={() => getDataBarangJasaById(item.id, "update")}
                >
                  Update
                </CButton>
                <CButton
                  ...
                  color="danger"
                  className="ml-1"
                  onClick={() => getDataBarangJasaById(item.id, "delete")}
                >
                  Delete
                </CButton>
              </CCardBody>
